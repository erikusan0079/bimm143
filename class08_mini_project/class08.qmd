...
Before we get stuck into project work we will have a quick look at applying PCA to some examples RNASeq data (tail end of lab 7).

Read the dataset (detailed in lab 7):
```{r}
...
skipped in class, will come back to it
